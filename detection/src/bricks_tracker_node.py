...
class Node:
    ...
    def callback_tim(self,timer_event):
        ...
        ps_near_small=PolygonStamped(header=Header(frame_id="base_link"),polygon=self.convert_poly_to_msg(near_poly_small))
        self.camera_area_near_small_pub.publish(ps_near_small)
        ps_far_small=PolygonStamped(header=Header(frame_id="base_link"),polygon=self.convert_poly_to_msg(far_poly_small))
    ...
    def callback(self,det):
        ...
        near_poly_small_map=self.transform_poly(near_poly_small,det.header.stamp,"base_link","map")
        far_poly_small_map=self.transform_poly(far_poly_small,det.header.stamp,"base_link", "map")
        new_bricks=[]
