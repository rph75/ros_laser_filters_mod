...
pipe=gstreamer_pipeline_3(sensor_id=1,sensor_mode=3,capture_width=800,capture_height=600,display_width=800,display_height=600,framerate=30,flip_method=2)
#cap1 = cv2.VideoCapture(pipe1,cv2.CAP_GSTREAMER)
cap = cv2.VideoCapture(pipe,cv2.CAP_GSTREAMER)

while True:
    ret, image = cap.read()
    image = show_size(image,1)
