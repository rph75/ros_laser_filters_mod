...
pipe1=gstreamer_pipeline_4(sensor_id=1,sensor_mode=3,capture_width=800,capture_height=600,display_width=800,display_height=600,framerate=30,flip_method=2)
...
while True:
    ...
    image0 = show_size(image0,0)
    image1 = show_size(image1,1)
    image = cv2.vconcat([image1, image0])
